...
public interface Constantes {
    ...
    public final int NUMERO_OBSTACULOS=(NUMERO_CELDAS_ANCHO*NUMERO_CELDAS_LARGO)/12;
    public final int NUMERO_OBSTACULOS_2=(NUMERO_CELDAS_ANCHO*NUMERO_CELDAS_LARGO)/10;
    public final int NUMERO_ADVERSARIOS=(NUMERO_CELDAS_ANCHO*NUMERO_CELDAS_LARGO)/25;
